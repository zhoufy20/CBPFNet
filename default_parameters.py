...
default_train_config = {
    ...
    'gat_node_dim_list': [len(default_elements), 128, 164, 200],
    'energy_readout_node_list': [600, 500, 300, 100, 50, FIX_VALUE[0]],
    'force_readout_node_list': [600, 500, 300, 100, 50, 25, FIX_VALUE[1]],
    'bias': True,
    'negative_slope': 0.2,
