...
default_data_config =  {
    ...
    'mask_reversed_magnetic_moments': False, 
    # or -0.5 # Frames with atomic magnetic moments lower than this value will be masked.
    'energy_stride': 0.05,
    'scale_prop': False
             }
...
default_train_config = {
    ...
    'gat_node_dim_list': [len(default_elements), 8, 16, 32, 64, 64, 100, 100],
    'energy_readout_node_list': [600, 450, 300, 150, 100, 50, 25, 10, FIX_VALUE[0]],
    'force_readout_node_list': [600, 450, 300, 150, 100, 50, 25, 10, FIX_VALUE[1]],
    'stress_readout_node_list': [600, 450, 300, 150, 100, 50, 25, 10, FIX_VALUE[2]], 
    # the first value should be: len(head_list)*gat_node_dim_list[-1]
    'bias': True,
    'negative_slope': 0.2,
