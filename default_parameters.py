...
default_train_config = {
    ...
    'gat_node_dim_list': [len(default_elements), 120, 120, 150, 150, 200, 200],
    'energy_readout_node_list': [1200, 1000, 800, 800, 400, 200, 100, 50, 10, FIX_VALUE[0]],
    'force_readout_node_list': [1200, 1000, 800, 800, 400, 200, 100, 50, 10, FIX_VALUE[1]],
    'bias': True,
    'negative_slope': 0.2,
