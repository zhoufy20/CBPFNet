...
if __name__ == '__main__':
    ...
    # f = Fit(dataset_path='../protein/train_data/paths.log', output_files='out_put/finetune')
    # f.fit()
    # t = echo(path_file='../protein/train_data/paths.log', output_files='out_put/datasetproteinpredict')
    # t.output()
    # # model test
    # # t = Test(path_file="../protein/train_data/paths.log", output_files='out_put/proteinpredict')
    # # t.output()
