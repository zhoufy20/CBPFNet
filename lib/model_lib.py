...
def load_model(model_save_dir='agat_model', device='cuda'):
    ...
    :param model_save_dir: A directory to store the models, defaults to 'agat_model'
    :type model_save_dir: str, optional
    :param device: Device for the loaded models, defaults to 'cuda'
    :type device: str, optional
    :return: A PyTorch-based models.
    :rtype: PyTorch-based models.
...
def save_state_dict(model, state_dict_save_dir='agat_model', **kwargs):
    """Saving state dict (models weigths and other input info) to the disk. See: https://pytorch.org/tutorials/beginner/basics/saveloadrun_tutorial.html

    :param model: A PyTorch-based models.
    :type model: PyTorch-based models.
    :param state_dict_save_dir: A directory to store the models state dict (models weigths and other input info), defaults to 'agat_model'
...
def load_state_dict(state_dict_save_dir='agat_model'):
    """Loading state dict (models weigths and other info) from the disk. See: https://pytorch.org/tutorials/beginner/basics/saveloadrun_tutorial.html

    :param state_dict_save_dir:  A directory to store the models state dict (models weigths and other info), defaults to 'agat_model'
    :type state_dict_save_dir: str, optional
    :return: State dict.
    :rtype: TYPE

    .. note::
        Reconstruct a models/optimizer before using the loaded state dict.
...
class EarlyStopping:
    ...
    #     '''Saves models when validation loss decrease.'''
    #     torch.save({models.state_dict()}, os.path.join(self.model_save_dir, 'agat_state_dict.pth'))
