...
class Predictone(object):
    ...
    def __init__(self, **test_config):
        ...
        if os.path.exists(os.path.join(self.test_config['model_save_dir'], 'agat_state_dict.pth')):
            try:
                print(self.test_config['model_save_dir'])
...
if __name__ == '__main__':
    ...
    # database.build()
    t = Predictone(path_file='../../Dataset/paths.log', dataset_path='../dataset/Testset/all_graphs.bin', output_files='../out_put/predict')
    t.output()